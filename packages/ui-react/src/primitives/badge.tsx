...
const badgeVariants = cva(
  "inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-neutral-ring focus:ring-offset-2 [--badge-bg:var(--neutral-fg-subtle)] [--badge-fg:var(--neutral-bg)]",
  {
    variants: {
      variant: {
