...
const badgeVariants = cva(
  "inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-ring focus-visible:ring-offset-2 [--badge-bg:var(--neutral-fg-subtle)] [--badge-fg:var(--neutral-bg)]",
  {
    variants: {
      variant: {
        ...
        outline: "border border-[var(--badge-bg)]/30 text-[var(--badge-bg)]",
      },
      color: {
